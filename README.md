...
The package requires at least Emacs 30.  It provides optional support for some
Emacs 31 features.  Such optional features always require two additional
checks:

```c
// Check that emacs-module.h has static support for Emacs 31.
#if defined EMACS_MAJOR_VERSION && EMACS_MAJOR_VERSION >= 31
...
#endif
// Some workaround in case Emacs 31 isn’t available.
```
